...
<template>
  <div class="container">
    <h1>Danh sach khu vuc quan ly (List Area)</h1>
    <el-table
      :data="
        tableData.filter(
          (data) =>
      ...
      style="width: 100%"
    >
      <el-table-column label="Ten khu vuc" prop="name" width="200" fixed>
      </el-table-column>
      <el-table-column label="Dia chi" prop="address" width="250">
      </el-table-column>
      <el-table-column label="Mo ta" prop="description" width="350">
      </el-table-column>
      <el-table-column
        label="Tinh trang"
        prop="status"
      ...
      tableData: [
        {
          ...
          status: "Active",
          description:
            "Quận Long Biên nằm ở phía đông bắc thành phố Hà Nội, cách trung tâm thành phố Hà Nội 1km (qua cầu Long Biên)",
