...
<template>
  <div class="container">
    <h1>Quản trị viên cấp vùng (List Admin)</h1>
    <el-table
      :data="
        tableData.filter(
          (data) =>
      ...
      style="width: 100%"
    >
      <el-table-column label="Ten" prop="name" width="200" fixed>
      </el-table-column>
      <el-table-column label="Anh" prop="image" width="300"> </el-table-column>
      <el-table-column label="Dia chi" prop="address" width="250">
      </el-table-column>
      <el-table-column label="Email" prop="email" width="250">
      </el-table-column>
      <el-table-column label="Mobile" prop="mobile" width="250">
      </el-table-column>
      <el-table-column label="Vung" prop="area" width="250"> </el-table-column>
      <el-table-column label="Ngay tao" prop="date_created" width="250">
      </el-table-column>
      <el-table-column label="Ngay cap nhat" prop="date_updated" width="250">
      </el-table-column>
      <el-table-column fixed="right" width="350">
        ...
        <template slot-scope="">
          <el-button size="mini" @click="editRole = true" class="btnEdit"
            >Edit</el-button
          >
          <el-button
            size="mini"
