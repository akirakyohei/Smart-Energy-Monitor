...
<template>
  <div class="container">
    ...
    >
      ...
      <el-table-column label="UserName" prop="name" width="200" fixed>
      </el-table-column>
      <el-table-column label="Ảnh" prop="image" width="300"> </el-table-column>
      <el-table-column label="Địa chỉ" prop="address" width="250">
      </el-table-column>
      <el-table-column label="Email" prop="email" width="250">
      </el-table-column>
      <el-table-column label="Số điện thoại" prop="mobile" width="250">
      </el-table-column>
      <el-table-column label="Khu vực" prop="area" width="250">
      </el-table-column>
      <el-table-column label="Ngày tạo" prop="date_created" width="250">
      </el-table-column>
      <el-table-column label="Ngày cập nhật" prop="date_updated" width="250">
      </el-table-column>
