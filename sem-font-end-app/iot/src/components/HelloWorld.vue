...
<div class="about-wrapper">
        <div class="about-left">
            <div class="about-left-content">
                <div>
                    <div class="shadow">
                        <div class="about-img">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTGf7VYZTDBo1FycrzMbPy5y-a-1NevPraVcd-aU95IiTJcT4CXxliwGTqsHcuXH-MxEWU&usqp=CAU" alt="about image">
                        </div>
                    </div>
        ...
        <div class="about-right">
            ...
            <div class="about-btns">
                  <router-link to="/sign" tag="button" class="btn btn-pink">LOG IN</router-link>
                  <router-link to="/register" tag="button" class="btn btn-white">REGISTER</router-link>
            </div>
