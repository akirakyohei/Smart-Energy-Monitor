      ...
      >
        <el-submenu index="1">
          ...
          <el-menu-item-group title="Manage Users">
            <el-submenu index="1-3">
              ...
              <el-menu-item index="1-3"
                ><span class="demonstration" @click="dialogTableVisible = true">User</span>
                <el-dialog>
                  <template slot="scope">
          ...
          <el-submenu index="1-4">
            ...
            <el-menu-item index="1-4">Electricity price</el-menu-item>
          </el-submenu>
        </el-submenu>
